...
public class PointTracker extends JFrame {
	...
	public PointTracker() {
		...
		ExamplePickBehavior behavior = new ExamplePickBehavior(canvas3D, scene,
				behaveBounds);
	...
	private class ExamplePickBehavior extends PickMouseBehavior {
		...
		public ExamplePickBehavior(Canvas3D canvas, BranchGroup bg,
				Bounds bounds) {
		...
		public void updateScene(int xpos, int ypos) {
			...
			if (pickResult != null) {
				...
				String s = String.format("(%.2f, %.2f, %.2f)", intercept.x,
